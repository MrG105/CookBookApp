...
import { validateCountry } from '../helpers/validate';

const TagsInput = ({ label, id, name, placeholder, error, onChange, defaultTags, countryValidation }) => {
    ...
    if(e.target.value !== '' && e.target.value !== ',') {
      ...
      if(e.key === ',') {
        ...
        if(countryValidation) {
          if(!tags.includes(newTag) && newTag !== '' && validateCountry(newTag)) {
